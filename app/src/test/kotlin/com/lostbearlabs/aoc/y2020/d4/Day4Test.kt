...
class Day4Test {
    @Test
    fun testSamplePart1() {
        val ps = parsePassportList(sample)
        assertThat(ps.count { it.hasRequiredFields() }).isEqualTo(2)
    }

    @Test
    fun testInputPart1() {
        val ps = parsePassportList(input)
        val answerPart1 = 254
        assertThat(ps.count { it.hasRequiredFields() }).isEqualTo(answerPart1)
    }

    @Test
    fun testSampleValidPart2() {
        val ps = parsePassportList(sampleValid)
        assertThat(ps.count{it.isValid()}).isEqualTo(ps.size)
    }

    @Test
    fun testSampleInvalidPart2() {
        val ps = parsePassportList(sampleInvalid)
        assertThat(ps.count{!it.isValid()}).isEqualTo(ps.size)
    }
    ...
    fun testInputPart2() {
        val ps = parsePassportList(input)
        val answerPart2 = 184
        assertThat(ps.count { it.isValid() }).isEqualTo(answerPart2)
    }
